...
namespace PopColorPicker
{
    public class ColorPickerHueGridViewController: UIViewController
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            _paletteView = new UIScrollView(new RectangleF(0, 50f, 320f, (float)this.View.Frame.Height - 120f));
        ...
        public void ColorBarTapped(UITapGestureRecognizer recognizer)
        {
            ...
            var frame = new RectangleF(page * 320f, 0f, 320f, (float)_paletteView.Frame.Size.Height);
