        ...
        private void DrawColorSqure()
        {
            ...
            using (var context = UIGraphics.GetCurrentContext())
            {
                ...
                path.AddLines(new CGPoint[]
                    {
                        ...
                        new CGPoint(endX, startY), 
                        new CGPoint(endX, endY),
                        new CGPoint(startX, endY)
                    });
                ...
                using (var rgb = CGColorSpace.CreateDeviceRGB())
                {
                    ...
                    context.DrawLinearGradient(gradient1, new CGPoint(startX, startY), new CGPoint(endX, startX), 0);
                    context.DrawLinearGradient(gradient2, new CGPoint(startX, startY), new CGPoint(startY, endY), 0);
                }
            }
        }
