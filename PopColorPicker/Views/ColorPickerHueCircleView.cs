...
namespace PopColorPicker
{
    public class ColorPickerHueCircleView : UIView
    {
        ...
        {
            var size = new SizeF((float)this.Bounds.Size.Width, (float)this.Bounds.Size.Height);
        ...
        {
            var size = new SizeF((float)this.Bounds.Size.Width - 40f, (float)this.Bounds.Size.Height - 40f);
        ...
        {
            var center = new PointF((float)this.Bounds.Width / 2f, (float)this.Bounds.Height / 2f);
