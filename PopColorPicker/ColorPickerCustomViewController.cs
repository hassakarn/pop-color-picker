...
namespace PopColorPicker
{
    public class ColorPickerCustomViewController : UIViewController
    {
        ...
        private void SetSliders()
        {
            ...
            var labelR = new UILabel(new RectangleF(new PointF(labelX, (float)_sliderR.Frame.Y), labelSize));
            labelR.Text = "R";
            labelR.TextColor = UIColor.White;
            this.View.AddSubview(labelR);

            var labelG = new UILabel(new RectangleF(new PointF(labelX, (float)_sliderG.Frame.Y), labelSize));
            labelG.Text = "G";
            labelG.TextColor = UIColor.White;
            this.View.AddSubview(labelG);

            var labelB = new UILabel(new RectangleF(new PointF(labelX, (float)_sliderB.Frame.Y), labelSize));
            labelB.Text = "B";
            ...
            _labelRValue = new UILabel(new RectangleF(new PointF(labelValueX, (float)_sliderR.Frame.Y), labelValueSize));
            _labelRValue.Text = "255";
            _labelRValue.TextColor = UIColor.White;
            this.View.AddSubview(_labelRValue);

            _labelGValue = new UILabel(new RectangleF(new PointF(labelValueX, (float)_sliderG.Frame.Y), labelValueSize));
            _labelGValue.Text = "0";
            _labelGValue.TextColor = UIColor.White;
            this.View.AddSubview(_labelGValue);

            _labelBValue = new UILabel(new RectangleF(new PointF(labelValueX, (float)_sliderB.Frame.Y), labelValueSize));
            _labelBValue.Text = "0";
        ...
        private void UpdateLabels()
        {
            ...
            var parent = this.ParentViewController as ColorPickerViewController;
