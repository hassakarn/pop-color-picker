...
namespace PopColorPicker
{
	public class ColorPickerFavoriteViewController : UIViewController
	{
		...
		public override void ViewDidLoad()
		{
            ...
            _paletteView = new UIView(new RectangleF(0, 10f, 320f, (float)View.Frame.Height - 80f));
            ...
            _deleteView.Frame = new RectangleF(0f, (float)View.Bounds.Bottom, (float)View.Frame.Width, 190f);
            ...
            _removeLabel = new UILabel(new RectangleF((float)_deleteView.Center.X - 15, 20f, 100f, 20f));
        ...
        private CGRect _previousDeleteViewFrame;
