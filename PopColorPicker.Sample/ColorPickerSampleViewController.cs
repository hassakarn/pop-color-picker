...
using PopColorPicker;

namespace PopColorPicker.Sample
{
    public partial class ColorPickerSampleViewController : UIViewController
    {
        ...
        public ColorPickerSampleViewController(IntPtr handle)
            : base(handle)
        {
        }
        ...
        private ColorPickerViewController _colorPickerViewController;
        ...
        public override void ViewDidLoad()
        {
            ...
            _colorPickerViewController = new ColorPickerViewController();
